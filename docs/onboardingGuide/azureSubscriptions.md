...
5. [**Advanced Security configuration (Optional)**](../../onboardingGuide/azureAdvanceSecurityConfiguration/) includes adding a script to the customer’s Azure account and granting the required access rights.
...
| 5 | [Advanced Security configuration](../../onboardingGuide/azureAdvanceSecurityConfiguration/)            | Microsoft Azure| Subscription Owner, Global AD Reader          | optional  | 18            |
...
Please follow [link](../../onboardingGuide/azureAdvanceSecurityConfiguration/) for steps.
