...
3.  **Policies & Benchmarks Additions/Updates**
    *   Added the following 5 new security policies for M365 cloud account. For upgrading the existing M365 account, refer << M365 adv sec doc link >> to get data for the below policies. Please provide version <<>> while executing the script
