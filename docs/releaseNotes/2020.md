...
2. **Platform & Stability Improvements**
    ...
    -   **[New]** AWS account onboarding using AWS config: AWS Account onboarding
        ...
        **Details:** [AWS Config](https://aws.amazon.com/config/) enables you to
        ...
        Config APIs, Cloudneeti will now be able to pull our resource configuration
        ...
        for more
        details [here](https://cloudneeti.github.io/Cloudneeti_SaaS_Docs/gettingStarted/securityPolicies/#manual)\<\<link
        to be updated to prod docs\>\>
    ...
    -   Fixed following bugs
        ...
        -   .... \<\<will add fixed bug here\>\>

        -   …

3. **Updates to Security Policies & Benchmarks**

    -   **Added** following 44 AWS Red Hat Enterprise Linux (RHEL) VM Baseline
        policies
    ...
    -   **Updated** following 3 policies for M365 to automatically get data from
        Microsoft 365 using automation account (PS).
    ...
    -   **Updated** following 10 AWS policies as Manual as AWS config API does not
        support these as of now
