...
-   **User Experience Improvements**
    ...
    -   **Updated** the 'Billing Dashboard page' to download billing details and
        billed resources at an Account level - CSV report
    ...
    -   **Updated** the ‘Onboarding Health Status’ page to now include the status of
        Azure Service Principal, M365 Service Principal, and Partner Admin ink
        (PAL). [Refer documentation](../../administratorGuide/manageAccounts/#onboarding-health-status-preview){target=_blank}

    -   **Added** support for Rapid-7 Azure Vulnerability Solutions. Enabling
