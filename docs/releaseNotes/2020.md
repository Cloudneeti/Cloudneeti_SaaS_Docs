...
3.  **Policies & Benchmarks Additions/Updates**
    *   Added the following 5 new security policies for M365 cloud account. For upgrading the existing M365 account, refer page <a href="/onboardingGuide/office365AdvanceSecurityConfigurationUpdate/" target="_blank">Office 365 - Update Advance Security Configuration</a> to get data for the below policies. Please provide version 1.3 while executing the script
