...
-   Updates to Security Policies & Benchmarks 
    ...
    -   **Added** a new security benchmark “*Unclassified - Naval Nuclear Propulsion
        Information (U-NNPI)*” for following cloud account
    ...
    <details>
    <summary> **Added** the following 167 new security policies for AWS cloud account</summary>
