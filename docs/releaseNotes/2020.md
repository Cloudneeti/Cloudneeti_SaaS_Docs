...
-   **User Experience Improvements**
    ...
    -   **Updated** the' Billing Dashboard page'. This release provides aggregated
        ...
        invoices across all accounts in a license. Refer to the documentation for
        more details. [Refer documentation](../../administratorGuide/billingDashboard/#aggregated-resource-counts-at-license-level){target=_blank}
...
-   **User Experience Improvements**
    ...
    -   **Added** 'Billing Dashboard page'. This release provides billing visibility to the consumed resource capacity. Customers/Partners can now use the resource consumption data to calculate the monthly/yearly invoices. Refer to the documentation for more details. 
    [Refer documentation](../../administratorGuide/billingDashboard/) 
