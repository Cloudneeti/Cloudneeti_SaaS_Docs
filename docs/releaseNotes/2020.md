...
-   **User Experience Improvements**
    ...
    -   **Updated** the *Utilization dashboard* this release provides billing
        ...
        the resource consumption data to calculate the monthly/yearly invoices
        across all accounts in a license. [Refer
        documentation](https://cloudneeti.github.io/Cloudneeti_SaaS_Docs/administratorGuide/billingDashboard/#aggregated-resource-counts-at-license-level)

    -   **Updated** the Asset Security Dashboard to have asset visibility aggregated
        at license level for asset compliance status and risk. Search available for
        Asset Tags.

    -   **GCP integration (preview)** onboard and scan GCP project/organization in
        CSPM to see compliance posture for IAM, Compute instance, Buckets, Networks,
        etc.
...
-   **Platform & Stability Improvements**
    ...
    -   **Fixed** following bugs
        ...
        -   After executing IAM runbook, 4 policies are not visible on CSBP and CIS
...
-   **Updates to Security Policies & Benchmarks** 
    ...
    <details>
    <summary>**Added following 64 new security policies for GCP cloud account**</summary>
