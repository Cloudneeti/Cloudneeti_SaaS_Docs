...
1.  **User Experience Improvements**
    - Added audit log, reports, and email notifications for an association of private benchmarks
...
3.  **Policies & Benchmarks Additions/Updates**
    *   Added the following 5 new security policies for M365 cloud account. For upgrading the existing M365 account, refer <a href="https://docs.cloudneeti.com/onboardingGuide/office365AdvanceSecurityConfigurationUpdate/" target="_blank">M365 adv sec doc</a> to get data for the below policies. Please provide version <<>> while executing the script
