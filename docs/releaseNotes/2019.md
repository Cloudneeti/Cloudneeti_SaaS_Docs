...
1.  **User Experience Improvements**
    ...
    <td style="width:100px ;border: solid .5px #9b9292">![November 2019 - Release 2.21.1](.././images/releaseNotes/NewRiskLevel.png)  </td>
    </tbody>
    </table>
...
3. **Policies & Benchmarks Additions/Updates**
    ...
    *	Updated 51 AWS security policies for Auto remediation. 
        ...
        <details>
        <summary>Deprecated following policies from Azure security best practices as those
        setting are updated in the Azure portal</summary> 
...
3.	**Policies & Benchmarks Additions/Updates**
    ...
    *   Introducing a new security benchmark
    ...
    <details>
    <summary>Disabled the following security policies for Azure cloud accounts as there are updates from Microsoft API response. These policies are disabled temporarily.</summary>
