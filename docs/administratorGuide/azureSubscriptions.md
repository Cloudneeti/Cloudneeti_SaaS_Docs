...
| 4. Download and review **PowerShell script** for creation of Cloudneeti  Service Principal | The PowerShell script is used to create a Cloudneeti  Service Principal in Azure Tenant AD: <a href="https://github.com/Cloudneeti/docs_cloudneeti/blob/master/scripts/Create-ServicePrincipal-AzureOnboarding.ps1" download>Download Link</a>. |
