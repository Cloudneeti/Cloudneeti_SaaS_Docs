...
![AWSOnboardingOverview](.././images/AWSOnboardingOverview.png#thumbnail)
...
2.	In PowerShell application, navigate to folder location where “serverless.yml” file is downloaded (e.g. “cd C:\Downloads”).
...
2.	Click on the ‘Activate License’ button to activate the license. This step is needed in case this is the first cloud account getting added in the License.
...
2.	Wait for the data to be collected, processed, and rendered to the Cloudneeti Dashboard, this may take a few minutes.
