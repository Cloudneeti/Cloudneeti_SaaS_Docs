Cloudneeti license is a group of accounts. Multiple Cloudneeti licenses can be provided to customer under one contract. Each customer’s cloud account is registered a Cloudneeti account. 
